...
layouts.Creative = {
  ...
  children: [
    /* Top bar */
    { type: 'image', id: 'tabBuilding', using: (ctx) => ctx.activeTab === 1 ? 'inventoryTabActive' : 'inventoryTab', x: 29 * 0, y: 0, tip: 'tooltips/cr/Building_Blocks', onClick: [] },
    { type: 'image', id: 'tabDecoration', using: (ctx) => ctx.activeTab === 2 ? 'inventoryTabActive' : 'inventoryTab', x: 29 * 1, y: 0, tip: 'tooltips/cr/Decoration_Blocks', onClick: [] },
    { type: 'image', id: 'tabRedstone', using: (ctx) => ctx.activeTab === 3 ? 'inventoryTabActive' : 'inventoryTab', x: 29 * 2, y: 0, tip: 'tooltips/cr/Redstone', onClick: [] },
    { type: 'image', id: 'tabTransport', using: (ctx) => ctx.activeTab === 4 ? 'inventoryTabActive' : 'inventoryTab', x: 29 * 3, y: 0, tip: 'tooltips/cr/Transportation', onClick: [] },
    { type: 'image', id: 'tabSaved', using: (ctx) => ctx.activeTab === 5 ? 'inventoryTabActive' : 'inventoryTab', x: width - 29 * 2, y: 0, tip: 'tooltips/cr/Saved_Inventories', onClick: [] },
    { type: 'image', id: 'tabSearch', using: (ctx) => ctx.activeTab === 6 ? 'inventoryTabActive' : 'inventoryTab', x: width - 29 * 1, y: 0, tip: 'tooltips/cr/Search', onClick: [] },
    /* Bottom bar */
    { type: 'image', id: 'tabMisc', using: (ctx) => ctx.activeTab === 7 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: 29 * 0, tip: 'tooltips/cr/Miscellaneous', onClick: [] },
    { type: 'image', id: 'tabFood', using: (ctx) => ctx.activeTab === 8 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: 29 * 1, tip: 'tooltips/cr/Foodstuffs', onClick: [] },
    { type: 'image', id: 'tabTools', using: (ctx) => ctx.activeTab === 9 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: 29 * 2, tip: 'tooltips/cr/Tools', onClick: [] },
    { type: 'image', id: 'tabCombat', using: (ctx) => ctx.activeTab === 10 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: 29 * 3, tip: 'tooltips/cr/Combat', onClick: [] },
    { type: 'image', id: 'tabBrewing', using: (ctx) => ctx.activeTab === 11 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: 29 * 4, tip: 'tooltips/cr/Brewing', onClick: [] },
    { type: 'image', id: 'tabSurvival', using: (ctx) => ctx.activeTab === 12 ? 'inventoryBotActiveTab' : 'inventoryBotTab', x: width - 28, tip: 'tooltips/cr/Survival', onClick: [] },
    /* The actual body */
    { type: 'image', using: (ctx) => ctx.activeTab === 6 ? 'tab_item_search' : (ctx.activeTab === 12 ? 'tab_inventory' : 'tab_items'), y: 30 },

    /* Tab Icons */
    { type: 'image', path: 'icons/minecraft_bricks', x: 6, y: 10, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_peony', x: (29 * 1) + 6, y: 10, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_redstone', x: (29 * 2) + 6, y: 10, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_powered_rail', x: (29 * 3) + 6, y: 10, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_bookshelf', x: width - (29 * 2) + 6, y: 10, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_compass', x: width - (29 * 1) + 6, y: 10, using: 'icon' },

    { type: 'image', path: 'icons/minecraft_lava_bucket', x: (29 * 0) + 6, y: height + 33, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_apple', x: (29 * 1) + 6, y: height + 33, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_iron_axe', x: (29 * 2) + 6, y: height + 33, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_golden_sword', x: (29 * 3) + 6, y: height + 33, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_potion', x: (29 * 4) + 6, y: height + 33, using: 'icon' }, //water bottle
    { type: 'image', path: 'icons/minecraft_chest', x: width - (29 * 1) + 7, y: height + 33, using: 'icon' },
  ...
  children: [
    ...
    },
    {
      type: 'container', x: 60, y: 14, children: [
        { type: 'image', id: 'enchant1', tip: "tooltips/Placeholder", using: (ctx) => ctx.isActive('enchant1') ? 'hover_ench' : (ctx.enchant1 ? 'active_ench' : 'inactive_ench') },
    ...
    },
    {
      type: 'container', x: 60, y: 14 + 19, children: [
        { type: 'image', id: 'enchant2', tip: "tooltips/Placeholder", using: (ctx) => ctx.isActive('enchant2') ? 'hover_ench' : (ctx.enchant2 ? 'active_ench' : 'inactive_ench') },
    ...
    },
    {
      type: 'container', x: 60, y: 14 + 19 + 19, children: [
        { type: 'image', id: 'enchant3', tip: "tooltips/Placeholder", using: (ctx) => ctx.isActive('enchant3') ? 'hover_ench' : (ctx.enchant3 ? 'active_ench' : 'inactive_ench') },
      ...
      type: 'container', x: 4, y: 18, children: [
        {
          draw (ctx, self, [x, y]) {
            ...
            for (let i = 0; i < 7; i++) {
              ...
              layouts.push({
                type: 'container', x, y: y + (i * 20), w: 88, h: 20, tip: 'tooltips/placeholder', children: [
                  {
                    draw (ctx, self, [x, y]) {
