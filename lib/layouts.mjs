...
layouts.Creative = {
  ...
  children: [
    ...
    /* Tab Icons */
    { type: 'image', path: 'icons/minecraft_brick', x: 5, y: 8, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_peony', x: (29 * 1) + 5, y: 8, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_redstone', x: (29 * 2) + 5, y: 8, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_powered_rail', x: (29 * 3) + 5, y: 8, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_bookshelf', x: width - (29 * 2) + 5, y: 8, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_compass', x: width - (29 * 1) + 5, y: 8, using: 'icon' },

    { type: 'image', path: 'icons/minecraft_lava_bucket', x: (29 * 0) + 5, y: height + 31, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_apple', x: (29 * 1) + 5, y: height + 31, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_iron_axe', x: (29 * 2) + 5, y: height + 31, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_golden_sword', x: (29 * 3) + 5, y: height + 31, using: 'icon' },
    { type: 'image', path: 'icons/minecraft_potion', x: (29 * 4) + 5, y: height + 31, using: 'icon' }, //water bottle
    { type: 'image', path: 'icons/minecraft_chest', x: width - (29 * 1) + 6, y: height + 31, using: 'icon' },
